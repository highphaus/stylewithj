      ...
      <footer className="bg-[#5D4037] text-[#FFFFFF] pt-20 pb-10 px-6 lg:px-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          ...
          <div className="md:col-span-1">
            <span className="font-serif text-3xl tracking-wide font-medium block mb-2">Jenny</span>
            <span className="font-sans text-[10px] tracking-widest uppercase text-[#FFFFFF]/60 mb-6 block leading-relaxed">
              Personal Stylist • Image Consultant<br/>Personal Brand Strategist
            </span>
            <p className="font-sans text-[12px] text-[#FFFFFF]/80 leading-relaxed pr-4">
              Helping ambitious individuals transform their image, build confidence, and create lasting impressions through styling, grooming, and personal branding.
            </p>
          </div>
