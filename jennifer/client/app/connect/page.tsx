...
export function ConnectContent() {
  return (
    <main className="pt-40 pb-24 px-6 lg:px-12 max-w-[1200px] mx-auto">
      <h1 className="font-serif text-5xl md:text-6xl font-light mb-20 text-center tracking-tight">Let's Connect</h1>
          ...
          <form className="flex flex-col gap-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex flex-col gap-2">
                ...
                <input type="text" className="bg-transparent border-b border-black pb-2 font-sans focus:outline-none" required />
              </div>
              <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input type="email" className="bg-transparent border-b border-black pb-2 font-sans focus:outline-none" required />
            </div>
            
            <div className="flex flex-col gap-2">
              <label className="font-sans text-xs font-light">Message *</label>
              <textarea rows={4} className="bg-transparent border-b border-black pb-2 font-sans focus:outline-none resize-none" required></textarea>
            </div>
            
            <button type="submit" className="w-full md:w-auto self-start px-12 py-4 border border-black font-sans text-sm font-medium uppercase tracking-widest hover:bg-black hover:text-white transition-colors">
              Send Message
            </button>
          </form>
        </div>
